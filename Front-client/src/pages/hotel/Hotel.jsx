            ...
            <div className="hotelWrapper">
              ...
              <div data-aos='fade-up' className="hotelHead">
                ...
                <span className="hotelPriceHighLight">
                  Book a stay over {data.cheapestPrice * 23}.000 VNĐ and get a free airport taxi!
                </span>
                  ...
                  {data.photos?.slice(0, 4).map((photo, index) => (
                    ...
                    <div className="hotelImgWrapper" key={index}>
                      ...
                      {index === 3 && data.photos.length > 4 && (
                        <div className="overlay">+{data.photos.length - 4} more</div>
                      )}
              ...
              <div className="hotelDetails">
                ...
                <div className="hotelDetailsPrice">
                  ...
                  <h2> <b>{days * data.cheapestPrice * option.room * 23}.000 VNĐ</b>
